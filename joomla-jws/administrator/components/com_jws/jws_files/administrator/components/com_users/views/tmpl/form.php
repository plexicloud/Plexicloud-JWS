		...
		<legend><?php echo JText::_( 'User Details' ); ?></legend>
			<table class="admintable" cellspacing="1">
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="apikey" id="apikey" size="40" value="<?php echo $this->user->get('_apikey'); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
						<label for="secretkey">
							<?php echo JText::_( 'Secretkey' ); ?>
						</label>
					</td>
					<td>
						<input class="inputbox" type="text" name="secretkey" id="secretkey" size="40" value="<?php echo $this->user->get('_secretkey'); ?>" />
					</td>
				</tr>
				...
				<tr>
					<td class="key">
						<?php echo JText::_( 'Block Apikey' ); ?>
					</td>
					<td>
						<?php echo $this->lists['api']; ?>
					</td>
				</tr>
